...
The company Pewlett-Hackard is forcasting a "silver tsunamis" as many current employees are reaching retirement age. Bobby and I are creating a report for the managers at Pewlett-Hackard to determine the number of retiring employees per title and to help identify employees who are eligible to participate in a mentorship program. For our analysis we took a deep dive into employees who were born between 1952-1955 are considered retirement ready and employees who were born in 1965 would be eligible for mentorship. 

## Results:

* There is 133,776 employees in this "Retirement Titles" table who had birthdates in years 1952-1955.
* This table contains duplicates when the employee got a promotion or job transpher. 
...
* This "Unique Titles" table was filtered from "Retirement Titles" table to remove the dupicates of promotions or job trasphers. 
* This table is also filtered to current employees.
* There is 72,458 current employees ready to retire!!
#### Unique Titles Table
...
* There is 1,549 eligible current employees ready to get mentored.
 ...
 * Three year birthdate range 1964-1966 output is 19,905 employees's
 * Five year birthdate range of 1963-1967 has 38,401 eligble employees... this is a bit better but still no where close to replacing 72,000 employees with industry knowledge
...
#### Past Employee Average durration of employment at PH
 ...
 #### Average Durration of Employment
